...
class Robot_controller:
    def __init__(self):
		...
		take_off = rospy.Service('take_off', take_off, self.take_off_func)
		z_height = rospy.Service('z_height', z_height, self.height_func)
		follow_moving = rospy.Service('follow_moving', follow_moving, self.follow_moving_func)
